...
public class GateConfig {
    ...
    @Bean
    public TokenSignerPort tokenSignerPort(GateProperties gateProperties) {
        return new HmacTokenSigner(gateProperties.sync().tokenSecret());
    }
    ...
    public ScheduleQueryPort scheduleQueryPort(ReactiveRedisTemplate<String, String> redisTemplate,
                                               ClockPort clockPort,
                                               GateProperties gateProperties) {
        return new RedisScheduleQuery(redisTemplate, clockPort, gateProperties);
    }
}
