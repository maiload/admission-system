...
public final class SqlQueries {
    ...
    public static final String HOLD_COUNT_BY_SCHEDULE_AND_CLIENT = """
            SELECT COUNT(*) AS cnt FROM holds WHERE schedule_id = :scheduleId AND client_id = :clientId
            """;
    ...
    public static final String RESERVATION_COUNT_BY_SCHEDULE_AND_CLIENT = """
            SELECT COUNT(*) AS cnt FROM reservations WHERE schedule_id = :scheduleId AND client_id = :clientId
            """;
